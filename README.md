...
<h3>🤎 Data analyst with over 9 years of
experience collaborating with tech
companies in SaaS and business
solutions, recognized as a go-to
subject matter expert in invoice
consolidation, employee benefits
reporting, and reconciliation. Highly
skilled in leveraging Excel, SQL,
and Tableau to manage sensitive
stakeholder data, deliver business
intelligence, generate actionable
insights, and support informed
decision-making.
</h3>    
    <p align="center">
...
<a href="https://camilingjs.com">
    <p align="center">
        <img width="120px" alt="Crunchbase" src="https://res.cloudinary.com/dxctpvd8v/image/upload/v1731484852/Data_Analysis/Crunchbase_WoB_fkcx36" />
        ...
        <img width="120px" alt="Conga" src="https://res.cloudinary.com/dxctpvd8v/image/upload/v1731485095/Data_Analysis/Conga_WoB_dote39" />
        ...
        <img width="120px" alt="Habitat For Humanity" src="https://res.cloudinary.com/dxctpvd8v/image/upload/v1731484204/Data_Analysis/Habitat_WoB_ogpgvw" />
        <img width="120px" alt="Baja Fresh Enterprise" src="https://res.cloudinary.com/dxctpvd8v/image/upload/v1731484339/Data_Analysis/Fresh_WoB_fjlck0" />
        ...
        <img width="120px" alt="Synergy One Lending" src="https://res.cloudinary.com/dxctpvd8v/image/upload/v1731484613/Data_Analysis/SynergyOneLending_WoB_mc9cng" />
...
<table>
        ...
        <tr>
            <td width="20%">
                <div align="center" valign="bottom">
                    <img src="https://res.cloudinary.com/dxctpvd8v/image/upload/v1735969294/JonathanCamiling_Excel_Logo" width="56%" alt="Excel" />
                </div>
                <br>
                <h2 width="100%" align="center" valign="top">Excel</h2>
            </td>
            <td width="20%">
                <div align="center" valign="bottom">
                    <img src="https://res.cloudinary.com/dxctpvd8v/image/upload/v1735971496/JonathanCamiling_SQL_Logo" width="56%" alt="SQL" />
                </div>
                <br>
                <h2 width="100%" align="center" valign="top">SQL</h2>
            </td>
            <td width="20%">
                <div align="center" valign="bottom">
                    <img src="https://res.cloudinary.com/dxctpvd8v/image/upload/v1735972208/JonathanCamiling_Tableau_Logo_" width="56%" alt="Tableau" />
                </div>
                <br>
                <h2 width="100%" align="center" valign="top">Tableau</h2>
            </td>
        </tr>
    </table>
    <h1></h1>
    ...
    <a href="https://cal.com/jaycam/30min">
        <p align="center">
            ...
            <img width="79px" alt="NodeJS" src="https://res.cloudinary.com/dxctpvd8v/image/upload/v1688167316/Icons/NodeJS_fu3vxy" />
            <img width="79px" alt="MongDB" src="https://res.cloudinary.com/dxctpvd8v/image/upload/v1688167316/Icons/MongoDB_kic9za" />
            ...
            <img width="79px" alt="Illustrator" src="https://res.cloudinary.com/dxctpvd8v/image/upload/v1688167314/Icons/Illustrator_lxern8" />
            <img width="79px" alt="Photoshop" src="https://res.cloudinary.com/dxctpvd8v/image/upload/v1688167316/Icons/Photoshop_yhelr4" />
            <img width="79px" alt="Shopify" src="https://res.cloudinary.com/dxctpvd8v/image/upload/v1688167320/Icons/Shopify_hzeqma" />
            <img width="79px" alt="Liquid" src="https://res.cloudinary.com/dxctpvd8v/image/upload/v1688167316/Icons/Liquid_fdghrg" />
        </p>
    </a>
